...
const page = () => {
  return (
    ...
    // a simple login page with name, email, password fields and a submit button and a link to register page (with some basic styling using tailwind css)
    <div className="flex flex-col items-center justify-center h-screen">
        ...
        <form className="flex flex-col w-80">
            ...
            <button type="submit" className="p-2 text-lg bg-blue-500 text-white rounded hover:bg-blue-600 hover:cursor-pointer">Register</button>
        </form>
